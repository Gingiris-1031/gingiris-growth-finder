...
|---|---|
| Product Hunt 런칭, 헌터 아웃리치, 런칭 당일 전술, 바이럴 모멘트 설계 | **[gingiris-launch](https://clawhub.ai/user/gingiris/gingiris-launch)** |
| GitHub 스타, HackerNews, OSS 마케팅, 개발자 커뮤니티, awesome-lists, Show HN | **[gingiris-opensource](https://clawhub.ai/user/gingiris/gingiris-opensource)** |
| B2B SaaS, PLG vs SLG, PMF 검증, 프리미엄, 엔터프라이즈 모션, 제휴, 채널 파트너십 | **[gingiris-b2b-growth](https://clawhub.ai/user/gingiris/gingiris-b2b-growth)** |
| ASO, App Store / Google Play, 모바일 유저 획득, TikTok/Reels/Shorts UGC, 크리에이터 매트릭스 | **[gingiris-aso-growth](https://clawhub.ai/user/gingiris/gingiris-aso-growth)** |
...
4개의 스페셜리스트 플레이북 모두 [github.com/Gingiris-1031](https://github.com/Gingiris-1031)에서 오픈소스로 공개되어 있으며, [clawhub.ai/user/gingiris](https://clawhub.ai/user/gingiris)에서 Claude Skills로 이용 가능합니다.
