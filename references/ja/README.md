...
|---|---|
| Product Hunt ローンチ、ハンター・アウトリーチ、ローンチ当日のタクティクス、バイラルモーメント設計 | **[gingiris-launch](https://clawhub.ai/gingiris-1031/gingiris-launch)** |
| GitHub スター、HackerNews、OSS マーケティング、デベロッパーコミュニティ、awesome-lists、Show HN | **[gingiris-opensource](https://clawhub.ai/gingiris-1031/gingiris-opensource)** |
| B2B SaaS、PLG vs SLG、PMF 検証、フリーミアム、エンタープライズモーション、アフィリエイト、チャネルパートナーシップ | **[gingiris-b2b-growth](https://clawhub.ai/gingiris-1031/gingiris-b2b-growth)** |
| ASO、App Store / Google Play、モバイルユーザー獲得、TikTok/Reels/Shorts UGC、クリエイターマトリックス | **[gingiris-aso-growth](https://clawhub.ai/gingiris-1031/gingiris-aso-growth)** |
...
4つのスペシャリストプレイブックはすべて [github.com/Gingiris-1031](https://github.com/Gingiris-1031) でオープンソースとして公開され、[clawhub.ai/gingiris-1031](https://clawhub.ai/gingiris-1031) で Claude Skills として利用可能です。
